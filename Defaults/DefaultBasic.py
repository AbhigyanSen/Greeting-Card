...
# Employee ID
user_ngs = int(input("Enter Employee NGS: "))
...
def overlay_transparent(BG_Step1, DP_Image, Output_Step1, target_height_percent=0.6, center_coords=(0,0)):
    ...
    print("STEP 1, DP on BG Successful")

# Example usage
if event == 1:
    BG_Step1 = "/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Images/Birthday/BG.png"
else:
    BG_Step1 = "/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Images/WorkAnniversary/BG.png"
DP_Image = f"/home/dcsadmin/Documents/PersonalisedGreeting/Potraits/MaskedPotraits/{user_ngs}Image-removebg-preview.png"
Output_Step1 = "/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Output/STEP1.png"
...
def overlay_on_existing(BG_Step2, Event_Path, Output_Step2, coordinates=(0, 0), resize_factor=0.5):
    ...
    print("STEP 2, Event on BG Successful")

# Example usage
BG_Step2 = "/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Output/STEP1.png"
if event == 1:
    Event_Path = "/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Images/Birthday/OV.png"
    coordinates = (60, 5)
else:
    Event_Path = "/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Images/WorkAnniversary/OV.png"
    coordinates = (1120, 730)
Output_Step2 = "/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Output/STEP2.png"
...
def add_text_to_image(BG_Step3, Text, font_path=None, font_size=50, text_color=(255, 255, 255)):
    ...
    image.save(f"/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Output/{user_ngs}Default.{BG_Step3[-3:]}")

    print("STEP 3, Name on BG Successful")

# Example usage
BG_Step3 = "/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Output/STEP2.png"
...
image_dir = "/home/dcsadmin/Documents/PersonalisedGreeting/Defaults/Output/"
# Desired images to keep
desired_image = f"{user_ngs}Default.png"

# Iterate through all files in the directory
for filename in os.listdir(image_dir):
    file_path = os.path.join(image_dir, filename)
    # Check if the current file is in the list of desired images
    if filename not in desired_image:
        try:
            os.remove(file_path)
